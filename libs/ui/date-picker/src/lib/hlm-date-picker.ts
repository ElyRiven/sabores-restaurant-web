...
export class HlmDatePicker<T> implements ControlValueAccessor {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      'ring-offset-background border-input bg-background dark:bg-input/30 dark:hover:bg-input/50 hover:text-accent-foreground inline-flex h-10 w-full cursor-default items-center justify-between gap-2 rounded-xl border py-2 px-3 text-left text-sm font-normal whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50',
